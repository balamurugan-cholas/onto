...
const policies: Record<LegalView, { title: string; sections: Array<{ heading: string; body: string }> }> = {
  terms: {
    ...
    sections: [
      { heading: 'Agreement', body: 'These Terms govern your purchase and use of VPlay, a downloadable plugin sold by Pluginverse. By purchasing, downloading, or using VPlay, you agree to these Terms.' },
      ...
      { heading: 'Liability', body: 'To the maximum extent permitted by law, VPlay is provided without guarantees of uninterrupted operation. Pluginverse is not liable for indirect, incidental, or consequential loss. Nothing in these Terms limits rights that cannot legally be excluded.' },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'Your choices and rights', body: 'You may request access to, correction of, or deletion of personal information held directly by Pluginverse, subject to legal and transaction-record requirements. Requests relating to Paddle-held payment data may also need to be directed to Paddle.' },
